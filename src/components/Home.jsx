  ...
  return (
    <div id="home" className='mt-10 md:mt-1 w-full  px-8  mt-10 md:flex items-center justify-between sm:flx-col'>
      <div className="w-full md:w-2/5">
        ...
        <a href={Resume} download="Om_Kothari_Resume" className='p-3 w-fit border-2 border-gray-400 rounded-full block mt-6 hover:border-3 hover:border-gray-600 hover:font-semibold'>Download Resume </a>
      </div>
